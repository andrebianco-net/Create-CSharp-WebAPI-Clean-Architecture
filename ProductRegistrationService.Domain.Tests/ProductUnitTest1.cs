...
namespace ProductRegistrationService.Domain.Tests
{
    public class ProductUnitTest1
    {
        ...
        public void CreateProduct_NegativeIdValue_DomainExceptionInvalidId()
        {
            ...
            action.Should().Throw<ProductRegistrationService.Domain.Validation.DomainExceptionValidation>()
        ...
        {
            Action action = () =>
                    new Product(1, "Product Name", "Product Description", 9.99m, 99, "product image toooooooooooooooooooooooooooooooooooooooooooo loooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooogggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggggg");
        ...
        {
            Action action = () =>
                    new Product(1, "Product Name", "Product Description", -9.99m, 99, "");
            action.Should().Throw<ProductRegistrationService.Domain.Validation.DomainExceptionValidation>()

...
## Overview:
Creating a C# .NET Core Web API based on Clean Architecture.
...
C# Web API .Net 7.0 based on Clean Architecture, using Web API, Repository, xUnit to test the implementation. I tryed to follow the theory bellow.
